    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                <!-- <li class="nav-item"><a href="{{ route('client') }}" class="nav-link font-20">Home</a></li> -->
                ...
                <li class="nav-item cta">
                    <a href="#" class="nav-link font-20" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
